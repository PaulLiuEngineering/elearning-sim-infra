...
inputs = {
  ...
  db_address_ssm_parameter_name  = "/nexa-learning/hk/prod/DB_ADDRESS"
  db_username_ssm_parameter_name = "/nexa-learning/hk/prod/DB_USERNAME"
  db_password_ssm_parameter_name = "/nexa-learning/hk/prod/DB_PASSWORD"
  tags = {
    cloud       = "aws"
    environment = "prod"
